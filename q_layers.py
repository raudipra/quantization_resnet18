...
from c_layers import CConvBNReLU2d, CAdd, CLinear
...
if __name__ == '__main__':
    ...
    # model.eval()
    #
    # x = torch.randint(0, 255, (1, 3, 3, 3))
    # q_out1 = model.conv1.q_out
    # q_out2 = model.layer1[0].conv2.q_out
    #
    # x1 = q_out1.dequantize_tensor(x)
    # x2 = q_out2.dequantize_tensor(x)
    #
    # add = QAdd()
    # add.convert_from(model.layer1[0].add, [q_out1, q_out2])
    #
    # y = add(x, x)
    # y = model.layer1[0].add.q_out.dequantize_tensor(y)
    # print(y[0][0])
    # print((x1 + x2)[0][0])
    pass
