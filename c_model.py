...
class CResnet18(nn.Module):
    def __init__(self, num_class, pretrained=True):
        ...
        self.layer1 = nn.Sequential(CBasicBlock(64, 64, layer_name='layer1.0'),
                                    CBasicBlock(64, 64, layer_name='layer1.1'))
        self.layer2 = nn.Sequential(CBasicBlock(64, 128, layer_name='layer2.0'),
                                    CBasicBlock(128, 128, layer_name='layer2.1'))
        self.layer3 = nn.Sequential(CBasicBlock(128, 256, layer_name='layer3.0'),
                                    CBasicBlock(256, 256, layer_name='layer3.1'))
        self.layer4 = nn.Sequential(CBasicBlock(256, 512, layer_name='layer4.0'),
                                    CBasicBlock(512, 512, layer_name='layer4.1'))
